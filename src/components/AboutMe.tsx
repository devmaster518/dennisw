...
export default function AboutMe() {
	...
	const detail2 = 'Do not hesitate to hire Dennis Wang to create something totally new successful together!';
	const detailJP_1 = '初めまして。王定と申します。カナダのCalgary市に在住しています。';
	const detailJP_2 =
		'JavaScript、Python、Goの経験豊富なシニア開発者として、あなたのプロジェクトを実現する準備ができています。イノベーションへの情熱と問題解決の才能を持ち、競争の激しい世界であなたと一緒に成長していきたいと考えています。共に素晴らしいものを創り上げましょう！';
	const detailJP_3 =
