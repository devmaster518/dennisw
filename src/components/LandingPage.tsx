...
export default function LandingPage() {
	const line1 =
		'Experienced in the dynamic world of JavaScript, Python, and Go, Dennis is a seasoned full-stack developer ready to bring your projects to life. With a passion for innovations and a knack for professional solutions, he is living in the fast-paced world of competition with you.';
	const line1JP =
		'JavaScript、Python、Goの経験豊富なシニア開発者として、あなたのプロジェクトを実現する準備ができています。イノベーションへの情熱と問題解決の才能を持ち、競争の激しい世界であなたと一緒に成長していきたいと考えています。';
	const linkResume =
	...
	const linkGitHub = 'https://github.com/devmaster518';
	const linkGoogleMap = 'https://www.google.com/maps?q=Calgary,+Alberta+T2A+0A1,+CA';
	const linkTelegram = 'https://t.me/codeguru827/';
