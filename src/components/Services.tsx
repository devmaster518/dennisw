...
const mobileSvcs: Service[] = [
	...
	},
	{
		index: 3,
		name: 'Capacitor',
		icon: <SiCapacitor className={'m-4 text-6xl text-cyan-400'} />,
	},
	{
		index: 4,
		name: 'Flutter',
		icon: <SiFlutter className={'m-4 text-6xl text-cyan-300'} />,
	},
	{
		index: 5,
		name: 'Electron',
	...
	},
	{
		index: 6,
		name: 'PWA',
		icon: <SiPwa className="m-4 text-6xl text-gray-900" />,
	},
	{
		index: 7,
		name: 'Apache Cordova',
		icon: <SiApachecordova className="m-4 text-6xl text-gray-400" />,
	},
];
